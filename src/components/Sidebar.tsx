...
export default function Sidebar() {
  return (
    <aside className="w-full h-full bg-white rounded-r-[2rem] shadow-lg flex flex-col items-center py-6 px-4">
      <nav className="flex flex-col gap-4">
        <NavButton> <img src="/SkylineLogo.png" alt="Custom icon" className="w-10 h-10 lg:w-15 lg:h-15 object-contain" /> </NavButton>
